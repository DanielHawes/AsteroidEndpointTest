...
1. [Optional]: User Authenticating with Google Accounts in Web Clients
    ...
    1. Update the `WEB_CLIENT_ID` in [Constants.java](src/main/java/com/example/b612/Constants.java)
...
1. [Optional]: User Authenticating with Google Accounts in other Applications
   Types
    ...
    - Inside [Constants.java](src/main/java/com/example/b612/Constants.java)
